# Calculate the effective atomic number for the human equivalent of the rib tissue types for PCD-CT
...
def interp_mean_zeff(low_t1, low_t2, high_t1, high_t2, material):
    ...
    spec_folder = r'D:\OneDrive - University of Victoria\Research\Material Decomposition\Beam Spectrum'
    folder = r'D:\OneDrive - University of Victoria\Research\Attenuation Data\Material Decomposition Inserts\Elements'
    ...
    energies = beam[:, 0] # Convert from MeV to keV
    spectrum = beam[:, 1]
...
if __name__ == '__main__':
    ...
    for mat in materials:
        print(mat, f'{interp_mean_zeff(35, 50, 65, 95, mat):0.3f}')
    print()
